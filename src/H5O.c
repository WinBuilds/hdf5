...
H5Oget_info2(hid_t loc_id, H5O_info_t *oinfo, unsigned fields)
{
    ...
    if(H5VL_object_optional(vol_obj, H5VL_OBJECT_OPT_GET_INFO, H5P_DATASET_XFER_DEFAULT, H5_REQUEST_NULL, &loc_params, oinfo, fields) < 0)
...
H5Oset_comment(hid_t obj_id, const char *comment)
{
    ...
    if(H5VL_object_optional(vol_obj, H5VL_OBJECT_OPT_SET_COMMENT, H5P_DATASET_XFER_DEFAULT, H5_REQUEST_NULL, &loc_params, comment) < 0)
...
H5Oget_comment(hid_t obj_id, char *comment, size_t bufsize)
{
    ...
    if(H5VL_object_optional(vol_obj, H5VL_OBJECT_OPT_GET_COMMENT, H5P_DATASET_XFER_DEFAULT, H5_REQUEST_NULL, &loc_params, comment, bufsize, &ret_value) < 0)
...
H5Odisable_mdc_flushes(hid_t object_id)
{
    ...
    /* Cork the object */
    if(H5VL_object_optional(vol_obj, H5VL_OBJECT_OPT_DISABLE_MDC_FLUSHES, H5P_DATASET_XFER_DEFAULT, H5_REQUEST_NULL, &loc_params) < 0)
        HGOTO_ERROR(H5E_OHDR, H5E_CANTCORK, FAIL, "unable to cork object");
...
H5Oenable_mdc_flushes(hid_t object_id)
{
    ...
    /* Uncork the object */
    if(H5VL_object_optional(vol_obj, H5VL_OBJECT_OPT_ENABLE_MDC_FLUSHES, H5P_DATASET_XFER_DEFAULT, H5_REQUEST_NULL, &loc_params) < 0)
        HGOTO_ERROR(H5E_OHDR, H5E_CANTUNCORK, FAIL, "unable to uncork object");
...
H5Oare_mdc_flushes_disabled(hid_t object_id, hbool_t *are_disabled)
{
    ...
    /* Get the cork status */
    if(H5VL_object_optional(vol_obj, H5VL_OBJECT_OPT_ARE_MDC_FLUSHES_DISABLED, H5P_DATASET_XFER_DEFAULT, H5_REQUEST_NULL, &loc_params, are_disabled) < 0)
        HGOTO_ERROR(H5E_OHDR, H5E_CANTGET, FAIL, "unable to retrieve object's cork status");
