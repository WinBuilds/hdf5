         ...
         void *buf)
{
    ...
    /* Read the raw chunk */
    if(H5VL_dataset_optional(vol_obj, H5VL_DATASET_OPT_CHUNK_READ, dxpl_id, H5_REQUEST_NULL, offset, filters, buf) < 0)
         ...
         size_t data_size, const void *buf)
{
    ...
    /* Write chunk */
    if(H5VL_dataset_optional(vol_obj, H5VL_DATASET_OPT_CHUNK_WRITE, dxpl_id, H5_REQUEST_NULL, filters, offset, data_size_32, buf) < 0)
