...
H5Fget_info1(hid_t obj_id, H5F_info1_t *finfo)
{
    ...
    if(H5VL_file_optional(vol_obj, H5VL_FILE_OPT_GET_INFO, H5P_DATASET_XFER_DEFAULT, H5_REQUEST_NULL, type, &finfo2) < 0)
...
H5Fset_latest_format(hid_t file_id, hbool_t latest_format)
{
    ...
    if(H5VL_file_optional(vol_obj, H5VL_FILE_OPT_SET_LIBVER_BOUNDS, H5P_DATASET_XFER_DEFAULT, H5_REQUEST_NULL, (int)low, (int)high) < 0)
