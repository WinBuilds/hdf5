    ...
    for(argno = 0; *type; argno++, type += (HDisupper(*type) ? 2 : 1)) {
        ...
        switch(type[0]) {
            case 'a':
                if(ptr) {
                    if(vp)
                        fprintf(out, "0x%llx", (unsigned long long)vp);
                    else
                        fprintf(out, "NULL");
                } /* end if */
                else {
                ...
                switch(type[1]) {
                    ...
                    case 'e':
                        if(ptr) {
                            ...
                            fprintf(out, "0x%llx", (unsigned long long)error);
                        } /* end else */
                        break;
                ...
                switch(type[1]) {
                    ...
                    case 's':
                        if(ptr) {
                            ...
                            fprintf(out, "0x%llx", (unsigned long long)statbuf);
                        }
                        break;
                ...
                if(ptr) {
                    if(vp) {
                        ...
                        if(asize_idx >= 0 && asize[asize_idx] >= 0) {
                            ...
                            for(i = 0; i < asize[asize_idx]; i++) {
                                if(p[i])
                                    fprintf(out, "%s0x%llx", (i ? ", " : ""), (unsigned long long)(p[i]));
                                else
                                    fprintf(out, "%sNULL", (i ? ", " : ""));
                            } /* end for */
                            fprintf(out, "}");
                ...
                switch (type[1]) {
                    ...
                    case 'c':
                        if(ptr) {
                            ...
                            fprintf(out, "0x%llx", (unsigned long long)filter);
                        } /* end else */
                        break;
