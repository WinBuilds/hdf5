...
H5Aget_num_attrs(hid_t loc_id)
{
    ...
    if(H5VL_object_optional(vol_obj, H5VL_OBJECT_OPT_GET_INFO, H5P_DATASET_XFER_DEFAULT, H5_REQUEST_NULL, &loc_params, &oinfo, H5O_INFO_ALL) < 0)
...
H5Aiterate1(hid_t loc_id, unsigned *attr_num, H5A_operator1_t op, void *op_data)
{
    ...
    if((ret_value = H5VL_attr_optional(vol_obj, H5VL_ATTR_OPT_ITERATE_OLD, H5P_DATASET_XFER_DEFAULT, H5_REQUEST_NULL, loc_id, attr_num, op, op_data)) < 0)
